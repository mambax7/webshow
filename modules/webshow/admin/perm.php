...
echo "<form method='post' name='fselperm' action='perm.php'><table border=0><tr><td><select name='permtoset' onChange='javascript: document.fselperm.submit()'><option value='1'"
     . $selected[0]
     . '>'
     . _WSA_VIEWFORM
