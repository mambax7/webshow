...
<span style=\"font-size:90%;\">" . _WSA_THEMEEDITORDSC . '</span>
    ...
    $tform->addElement(new XoopsformColorPicker('<b>'
                                                . _WSA_PLAYBGCLR
                                                . "</b><br><span style=\"font-size: 85%; font-weight: 500;\">"
                                                . $css_bgclr
                                                . "</span><br><span style=\"font-size: 80%; font-weight: 500; color: #CC0000;\">"
                                                . $css_bgclr_error
                                                . '</span>', 'themebgcolor', $themebgcolor), false);
    $tform->addElement(new XoopsformColorPicker('<b>'
                                                . _WSA_DISBKCLR
                                                . "</b><br><span style=\"font-size: 85%; font-weight: 500;\">"
                                                . $css_bkclr
                                                . "</span><br><span style=\"font-size: 80%; font-weight: 500; color: #CC0000;\">"
                                                . $css_bkclr_error
                                                . '</span>', 'themebackcolor', $themebackcolor), false);
    $tform->addElement(new XoopsformColorPicker('<b>'
                                                . _WSA_DISFTCLR
                                                . "</b><br><span style=\"font-size: 85%; font-weight: 500;\">"
                                                . $css_ftclr
                                                . "</span><br><span style=\"font-size: 80%; font-weight: 500; color: #CC0000;\">"
                                                . $css_ftclr_error
                                                . '</span>', 'themefrontcolor', $themefrontcolor), false);
    $tform->addElement(new XoopsformColorPicker('<b>'
                                                . _WSA_DISLTCLR
                                                . "</b><br><span style=\"font-size: 85%; font-weight: 500;\">"
                                                . $css_ltclr
                                                . "</span><br><span style=\"font-size: 80%; font-weight: 500; color: #CC0000;\">"
                                                . $css_ltclr_error
                                                . '</span>', 'themelightcolor', $themelightcolor), false);
...
<input type=\"button\" value=\"" . _WSA_THEMERESETALL . "\" onClick=\"location='themestyle.php?op=themeFilterAll&amp;theme=" . $theme . "'\">
    ...
    $linktree->makeMySelBox('title', 'lid', $lid, 0, 'lid',
                            'window.location="player.php?op=' . $playerop . '&amp;playerid=' . $playerid . '&amp;theme=' . $theme . '&amp;styleoption=2&amp;lid="+this.value');
...
{
    global $xoopsDB, $xoopsConfig, $xoopsModule, $xoopsModuleConfig, $myts;
    $lid      = isset($_GET['lid']) ? (int)$_GET['lid'] : $lid;
    $playerid = isset($_GET['playerid']) ? (int)$_GET['playerid'] : $playerid;
...
<span style=\"font-size:90%;\">" . _WSA_THEMEEDITORDSC . '</span>
    ...
    $tform->addElement(new XoopsformColorPicker('<b>'
                                                . _WSA_PLAYBGCLR
                                                . "</b><span style=\"font-size: 85%; font-weight: 500;\"><br>"
                                                . $css_bgclr
                                                . "</span><br><span style=\"font-size: 80%; font-weight: 500; color: #CC0000;\">"
                                                . $css_bgclr_error
                                                . '</span>', 'themebgcolor', $themebgcolor), false);
...
function themeColorS()
{
    ...
    $playerid    = isset($_POST['playerid']) ? (int)$_POST['playerid'] : '';
    $playerop    = isset($_POST['playerop']) ? $_POST['playerop'] : '';
    $styleoption = isset($_POST['styleoption']) ? (int)$_POST['styleoption'] : '';
    ...
    $xoopsDB->query('update ' . $xoopsDB->prefix('webshow_theme') . " set bgcolor='$bgcolor', backcolor='$backcolor', frontcolor='$frontcolor', lightcolor='$lightcolor' WHERE themetitle=\"$theme\"")
    or $eh->show('0013');
...
function themeFilter($theme)
{
    ...
    $lid         = isset($_GET['lid']) ? (int)$_GET['lid'] : '1';
    $playerid    = isset($_GET['playerid']) ? (int)$_GET['playerid'] : '1';
    $playerop    = isset($_GET['playerop']) ? (int)$_GET['playerop'] : '';
    $styleoption = isset($_GET['styleoption']) ? (int)$_GET['styleoption'] : '2';
    if ($theme == '') {
    ...
    if ($file) {
        ...
        if ($rowexists == '') {
            $sql = sprintf("INSERT INTO %s (themetitle, bgcolor, backcolor, frontcolor, lightcolor) VALUES ('%s', '%s', '%s', '%s', '%s')", $xoopsDB->prefix('webshow_theme'), $themetitle, $bgcolor,
                           $backcolor, $frontcolor, $lightcolor);
            $xoopsDB->queryF($sql) or $eh->show('0013');
        } else {
            $xoopsDB->queryF('update '
                             . $xoopsDB->prefix('webshow_theme')
                             . " set bgcolor='$bgcolor', backcolor='$backcolor', frontcolor='$frontcolor', lightcolor='$lightcolor' WHERE themetitle=\"$theme\"") or $eh->show('0013');
        }
    }
}
