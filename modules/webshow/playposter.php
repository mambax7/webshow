...
$xoopsOption['template_main'] = 'webshow_playposter.tpl';
...
if ($numrows > 1) {
    ...
    $sql    =
        ...
        . ' t where l.submitter='
        . $uid
        . " and l.lid=t.lid and status>0 ORDER by $orderby";
            ...
            if (count(array_intersect($group, $ws_entryperm)) > 0) {
                ...
                if (!$showplayer) {
                    ...
                    $title = "<a href=\""
                             ...
                             . '/modules/'
                             . $xoopsModule->getVar('dirname')
                             . "/playposter.php?lid=$lid&amp;cid=$cid&amp;uid=$submitter&amp;min=$rowid&amp;orderby=$orderby&amp;show=$show\" target=\"_self\" title=\""
                             . _WS_VIEWMEDIA
                             . ' - '
                             . $ltitle
                             . "\" rel=\"nofollow\">"
