...
$image_url     = XOOPS_URL . '/modules/webshow/assets/images/logo.gif';
...
if (!$tpl->is_cached('db:system_rss.tpl')) {
    ...
    $dimention = getimagesize(XOOPS_ROOT_PATH . '/modules/webshow/assets/images/logo.gif');
    ...
    $sql    =
        'select l.lid, l.cid, l.title, l.url, l.srctype, l.listtype, l.listurl, l.entryinfo, l.listcache, l.logourl, l.credit1, l.credit2, l.credit3, l.status, l.date, l.published, l.entryperm, t.description from '
        . $xoopsDB->prefix('webshow_links')
        . ' l, '
        . $xoopsDB->prefix('webshow_text')
        . " t where l.status>0 and $where and l.lid=t.lid ORDER by date DESC";
    $result = $xoopsDB->query($sql, 20, 0);
    while (list($lid, $cid, $title, $url, $srctype, $listtype, $listurl, $entryinfo, $listcache, $logourl, $credit1, $credit2, $credit3, $status, $date, $published, $ws_entryperm, $description) =
