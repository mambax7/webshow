...
function loadMovie($lid, $playerid, $styleoption)
{
    ...
    $result =
        $xoopsDB->query('select lid, cid, title, url, srctype, listtype, listurl, entryinfo, listcache, cachetime, logourl, submitter, status, date, published, expired, player, entryperm, entrydownperm from '
                        . $xoopsDB->prefix('webshow_links')
                        . " where lid=$lid");
    list($lid, $cid, $ltitle, $url, $srctype, $listtype, $listurl, $entryinfo, $listcache, $cachetime, $logourl, $submitter, $status, $date, $published, $expired, $player, $ws_entryperm,
        $ws_entrydownperm) = $xoopsDB->fetchRow($result);
    $playerid  = !empty($playerid) ? $playerid : $player;
    ...
    //** Make movie Link
    $movie = '<script type="text/javascript" src="'
             . XOOPS_URL
             . '/modules/'
             . $xoopsModule->getVar('dirname')
             . '/assets/js/swfobject.js"></script><div id="movie'
             . $lid
             . '"><a href="http://www.macromedia.com/go/getflashplayer">Get the Flash Player</a> to see this player.</div><script type="text/javascript">var s'
             . $lid
             . ' = new SWFObject("'
             . XOOPS_URL
             . '/modules/'
             ...
             . '");s'
             . $lid
             . '.addVariable("displaywidth","'
             . $displaywidth
             . '");s'
             . $lid
             . '.addVariable("displayheight","'
             . $displayheight
             . '");'
             . $backcolor
             . $frontcolor
