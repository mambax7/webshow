...
if ($listtype != '' & $srctype != '') {
    ...
    //** LIST TYPE LANGUAGE
    $listtypeicon = "<img src=\"" . XOOPS_URL . '/modules/' . $xoopsModule->getVar('dirname') . "/assets/images/link.gif\" alt=\"" . _VISITWEBSITE . "\" />";
    $embed_logo   = '';
    if ($listtype == 'embed') {
        $width      = '';
        $height     = '';
    ...
    if ($listtype == 'feed') {
        ...
        $listtypeicon = "<img src=\"" . XOOPS_URL . '/modules/' . $xoopsModule->getVar('dirname') . "/assets/images/webfeed.gif\" alt=\"" . _VISITWEBSITE . "\" />";
        $srctype      = 'feed';
    }
    if ($listtype == 'dir') {
    ...
    if ($listtype != 'embed' & $op == 'modLinkS' || $op == 'approve') {
        $sform->addElement(new XoopsFormText('<b>'
                                             . $listtypename
                                             . ' '
                                             . _WSA_LISTURL
                                             . "</b><a href=\""
                                             ...
                                             . "\" target=\"_blank\">"
                                             . $listtypeicon
                                             . "</a><br><span style=\"font-size:90%; font-weight: 500;\">"
                                             . $listtypedsc
                                             . '</span>', 'listurl', 60, 250, $listurl), true);
    } else {
        $sform->addElement(new XoopsFormText('<b>' . $listtypename . ' ' . _WSA_LISTURL . "</b><br><span style=\"font-size:90%; font-weight: 500;\">" . $listtypedsc . '</span>', 'listurl', 60, 250,
                                             $listurl), true);
    }
    ...
    //** Description
    $sform->addElement(new XoopsFormTextArea('<b>' . _WSA_BLOCKDESCRIPTION . ":</b><br><span style=\"font-size:90%; font-weight: 500;\">" . _WSA_BLOCKDESCRIPTION_DSC . '</span>', 'description',
                                             $description, 3, 40), true);
    ...
    if ($xoopsModuleConfig['tags'] & file_exists(XOOPS_ROOT_PATH . '/modules/tag/include/formtag.php')) {
        ...
        $itemid = $lid;
        $catid  = 0;
        $sform->addElement(new TagFormTag('item_tag', 60, 255, $itemid, $catid));
    } else {
    ...
    if (!empty($xoopsModuleConfig['path_logo'])) {
        if ($logourl == '' & $embed_logo != '') {
            $logo_image_tray =
                new XoopsFormElementTray('<b>' . _WSA_LOGOIMAGE . '<br>' . _WSA_EMBEDLOGO . "</b><br><span style=\"font-size: 90%; font-weight: 500;\">" . _WSA_EMBEDLOGO_DSC . '</span>', '');
            $sform->addElement(new XoopsFormHidden('embed_logo', $embed_logo), false);
        } else {
            $logo_image_tray = new XoopsFormElementTray('<b>'
                                                        . _WSA_LOGOIMAGE
                                                        . "</b><br><span style=\"font-size: 90%; font-weight: 500;\">"
                                                        . _WSA_LOGOIMAGE_DSC
                                                        . '<br><br>'
                                                        . _WSA_LOGOSIZE
                                                        . ' '
            ...
            if (!empty($logourl) && file_exists(XOOPS_ROOT_PATH . '/' . $xoopsModuleConfig['path_logo'] . '/' . $logourl)) {
                $image_tray->addElement(new XoopsFormLabel('<br>', "<div style=\"padding: 8px;\"><img src=\""
                                                                   . XOOPS_URL
                                                                   . '/'
                                                                   . $xoopsModuleConfig['path_logo']
                                                                   . '/'
                                                                   . $logourl
    ...
    if ($xoopsUser && $xoopsUser->isAdmin($xoopsModule->mid())) {
        ...
        if ($listtype != 'embed') {
            ...
            $playerlogo_option_tray = new XoopsFormElementTray('<b>'
                                                               . _WSA_PLAYERLOGOUPLOAD
                                                               . "</b><br><span style=\"font-size: 85%; font-weight: 500;\">"
                                                               . _WSA_LOGOSIZE
                                                               . ' '
                                                               . $playerlogosize
                                                               . 'bytes<br>'
            ...
            $path_playerlogo        = $xoopsModule->getVar('dirname') . '/assets/images/player';
            ...
            if (!empty($playerlogo) && file_exists(XOOPS_ROOT_PATH . '/modules/' . $path_playerlogo . '/' . $playerlogo)) {
                $playerlogo_tray->addElement(new XoopsFormLabel('', "<div style=\"padding: 8px;\"><img src=\""
                                                                    . XOOPS_URL
                                                                    . '/modules/'
                                                                    . $path_playerlogo
                                                                    . '/'
                                                                    . $playerlogo
                                                                    . "\" name=\"plogo\" id=\"plogo\" alt=\"\" /></div>"));
            } else {
                $playerlogo_tray->addElement(new XoopsFormLabel('', "<div style=\"padding: 8px;\"><img src=\""
                                                                    . XOOPS_URL
                                                                    . '/modules/'
                                                                    . $path_playerlogo
                                                                    . "/blank.gif\" name=\"plogo\" id=\"plogo\" alt=\"\" /></div>"));
            }
            ...
            //** Show Activity Icons
            $sform->addElement(new XoopsFormRadioYN('<b>' . _WSA_SHOWICONS . "</b><br><span style=\"font-size:90%; font-weight: 500;\">" . _WSA_SHOWICONSDSC . '</span>', 'showicons', $showicons, _YES,
                                                    _NO));

            //** Show EQ for MP3 Only
            if ($listtype == 'feed' || $srctype == 'mp3') {
                $sform->addElement(new XoopsFormRadioYN('<b>' . _WSA_SHOWEQ . "</b><br><span style=\"font-size:90%; font-weight: 500;\">" . _WSA_MP3_ONLY . '<br>' . _WSA_SHOWEQDSC . '</span>',
                                                        'showeq', $showeq, _YES, _NO));
            } else {
            ...
            if ($listtype == 'feed') {
                $sform->addElement(new XoopsFormRadioYN('<b>' . _WSA_ENABLEJS . "</b><br><span style=\"font-size:90%; font-weight: 500;\">" . _WSA_ENABLEJSDSC . '</span>', 'enablejs', $enablejs, _YES,
                                                        _NO));
            } else {
            ...
            //** Thumbnails
            $sform->addElement(new XoopsFormRadioYN('<b>' . _WSA_THUMB . "</b><br><span style=\"font-size:90%; font-weight: 500;\">" . _WSA_THUMBDSC . '</span>', 'thumbslist', $thumbslist, _YES,
                                                    _NO));

            //** Text Captions from URL for single file video entry only
            if ($listtype == 'single' & $srctype == 'flv') {
                $sform->addElement(new XoopsFormText('<b>' . _WSA_CAPTIONS . "</b><br><span style=\"font-size:90%; font-weight: 500;\">" . _WSA_CAPTIONSDSC . '</span>', 'captions', 60, 250,
                                                     $captions), false);
            } else {
            ...
            //** Image Rotation Time
            if ($listtype != 'single') {
                $sform->addElement(new XoopsFormText('<b>' . _WSA_ROTATETIME . "</b><br><span style=\"font-size:90%; font-weight: 500;\">" . _WSA_ROTATETIMEDSC . '</span>', 'rotatetime', 3, 2,
                                                     $rotatetime), false);
            } else {
            ...
            if ($srctype == 'image' || $srctype == 'feed') {
                ...
                $transition_tray =
                    new XoopsFormElementTray('<b>' . _WSA_TRANSITION . "</b><br><span style=\"font-size:90%; font-weight: 500;\">" . _WSA_IMAGES_ONLY . '<br>' . _WSA_TRANSITIONDSC . '</span>', '');
                ...
                $sform->addElement(new XoopsFormRadioYN('<b>' . _WSA_SHOWNAV . "</b><br><span style=\"font-size:90%; font-weight: 500;\">" . _WSA_SHOWNAVDSC . '</span>', 'shownav', $shownav, _YES,
                                                        _NO));
            } else {
            ...
            if ($op == 'modLinkS' & $listtype != 'single') {
                $sform->addElement(new XoopsFormLabel('<b>' . _WSA_LISTCACHE . '</b>', "<span style=\"font-size:90%; font-weight: 500;\"><a href=\""
                                                                                       . XOOPS_URL
                                                                                       . '/modules/'
                                                                                       . $xoopsModule->getVar('dirname')
                                                                                       . '/playlist/'
                ...
                $sform->addElement(new XoopsFormRadioYN('<b>' . _WSA_LISTCACHE_REFRESH . "</b><br><span style=\"font-size:90%; font-weight: 500;\">" . _WSA_LISTCACHE_REFRESHDSC . '</span>',
                                                        'refreshlist', 0, _YES, _NO));
            }
        }
    }
    ...
    if ($op == 'modLinkS') {
        $delete_btn =
            "<input type=\"button\" value=\"" . _DELETE . "\" onClick=\"location='" . XOOPS_URL . '/modules/' . $xoopsModule->getVar('dirname') . "/admin/index.php?lid=$lid&amp;op=delLink'\">";
