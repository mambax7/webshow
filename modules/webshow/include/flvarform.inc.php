...
if ($listtype == 'feed' || $srctype == 'mp3') {
    $sform->addElement(new XoopsFormRadioYN('<b>' . _WSA_SHOWEQ . "</b><br><span style=\"font-size:90%; font-weight: 500;\">" . _WSA_MP3_ONLY . '<br>' . _WSA_SHOWEQDSC . '</span>', 'showeq', $showeq,
                                            _YES, _NO));
} else {
...
//** Image Rotation Time
if ($listtype != 'single') {
    $sform->addElement(new XoopsFormText('<b>' . _WSA_ROTATETIME . "</b><br><span style=\"font-size:90%; font-weight: 500;\">" . _WSA_ROTATETIMEDSC . '</span>', 'rotatetime', 3, 2, $rotatetime),
                       false);
}
...
if ($xoopsUser->isAdmin($xoopsModule->mid())) {
    if ($listtype == 'single' & $srctype == 'flv') {
        $sform->addElement(new XoopsFormText('<b>' . _WSA_CAPTIONS . "</b><br><span style=\"font-size:90%; font-weight: 500;\">" . _WSA_CAPTIONSDSC . '</span>', 'captions', 40, 250, $captions),
                           false);
    } else {
