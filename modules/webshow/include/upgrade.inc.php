...
if ($xoopsDB->getRowsNum($result63e) > 0) {
    ...
    $xoopsDB->queryF('ALTER TABLE ' . $xoopsDB->prefix('webshow_links') . " CHANGE `showinfo` `entryinfo` VARCHAR(255) DEFAULT 'dsc logo cred stat sbmt pop tag feed site down' NOT NULL;")
    or $eh->show('0013');
}
...
if (file_exists(XOOPS_ROOT_PATH . '/modules/webshow/templates/webshow_linklite.tpl')) {
    unlink(XOOPS_ROOT_PATH . '/modules/webshow/templates/webshow_linklite.tpl');
}
