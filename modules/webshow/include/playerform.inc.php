...
$sform->addElement(new XoopsFormText('<b>' . _WSA_DISPLAYWIDTH . "</b><br><span style=\"font-size: 85%; font-weight: 500;\">" . _WSA_DISPLAYWIDTH_DSC . '</span>', 'displaywidth', 4, 4, $displaywidth),
                   false);
...
$sform->addElement(new XoopsFormText('<b>' . _WSA_SEARCHLINK . "</b><br><span style=\"font-size:85%; font-weight: 500;\">" . _WSA_SEARCHLINKDSC . '</span>', 'searchlink', 30, 250, $searchlink),
                   false);
