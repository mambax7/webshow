...
function adminMenu($currentoption = -1, $breadcrumb = '')
{
    ...
    echo "<li style=\"list-style: none; margin: 0; display: inline; \"><a href=\"index.php\" style=\"padding: 3px 0.5em; margin-left: 0; border: 1px solid #778; background: "
         . $tblColors[0]
         . "; text-decoration: none; white-space: nowrap; \">"
         . _MI_WEBSHOW_ADMENU1
         . '</a></li>';
    echo "<li style=\"list-style: none; margin: 0; display: inline; \"><a href=\"category.php\" style=\"padding: 3px 0.5em; margin-left: 3px; border: 1px solid #778; background: "
         . $tblColors[0]
         . "; text-decoration: none; white-space: nowrap; \">"
         . _MI_WEBSHOW_ADMENU2
         . '</a></li>';
    echo "<li style=\"list-style: none; margin: 0; display: inline; \"><a href=\"index.php?op=newLink\" style=\"padding: 3px 0.5em; margin-left: 3px; border: 1px solid #778; background: "
         . $tblColors[0]
         . "; text-decoration: none; white-space: nowrap; \">"
         . _MI_WEBSHOW_ADMENU3
         . '</a></li>';
    echo "<li style=\"list-style: none; margin: 0; display: inline; \"><a href=\"flashconfig.php\" style=\"padding: 3px 0.5em; margin-left: 3px; border: 1px solid #778; background: "
         . $tblColors[0]
         . "; text-decoration: none; white-space: nowrap; \">"
         . _MI_WEBSHOW_ADMENU4
         . '</a></li>';
    echo "<li style=\"list-style: none; margin: 0; display: inline; \"><a href=\"player.php\" style=\"padding: 3px 0.5em; margin-left: 3px; border: 1px solid #778; background: "
         . $tblColors[0]
         . "; text-decoration: none; white-space: nowrap; \">"
         . _MI_WEBSHOW_ADMENU5
         . '</a></li>';
    echo "<li style=\"list-style: none; margin: 0; display: inline; \"><a href=\"perm.php\" style=\"padding: 3px 0.5em; margin-left: 3px; border: 1px solid #778; background: "
         . $tblColors[0]
         . "; text-decoration: none; white-space: nowrap; \">"
         . _MI_WEBSHOW_ADMENU6
         . '</a></li>';
    echo "<li style=\"list-style: none; margin: 0; display: inline; \"><a href=\"index.php?op=listNewLinks\" style=\"padding: 3px 0.5em; margin-left: 3px; border: 1px solid #778; background: "
         . $tblColors[0]
         . "; text-decoration: none; white-space: nowrap; \">"
         . _MI_WEBSHOW_ADMENU7
         . '</a></li>';
    echo "<li style=\"list-style: none; margin: 0; display: inline; \"><a href=\"index.php?op=listBrokenLinks\" style=\"padding: 3px 0.5em; margin-left: 3px; border: 1px solid #778; background: "
         . $tblColors[0]
         . "; text-decoration: none; white-space: nowrap; \">"
         . _MI_WEBSHOW_ADMENU8
         . '</a></li>';
    echo "<li style=\"list-style: none; margin: 0; display: inline; \"><a href=\"index.php?op=listModReq\" style=\"padding: 3px 0.5em; margin-left: 3px; border: 1px solid #778; background: "
         . $tblColors[0]
         . "; text-decoration: none; white-space: nowrap; \">"
         . _MI_WEBSHOW_ADMENU9
         . '</a></li>';
    echo "<li style=\"list-style: none; margin: 0; display: inline; \"><a href=\"index.php?op=webShowHelp\" style=\"padding: 3px 0.5em; margin-left: 3px; border: 1px solid #778; background: "
         . $tblColors[0]
         . "; text-decoration: none; white-space: nowrap; \">"
         . _MI_WEBSHOW_ADMENU10
         . '</a></li>';
    echo "<li style=\"list-style: none; margin: 0; display: inline; \"><a href=\"../index.php\" style=\"padding: 3px 0.5em; margin-left: 3px; border: 1px solid #778; background: "
         . $tblColors[0]
         . "; text-decoration: none; white-space: nowrap; \">"
         . _MI_WEBSHOW_ADMENU11
         . '</a></li></ul></div><br>';
}
...
{
    if ($orderby == 'hits ASC') {
        $orderbyTrans = '' . _WS_PAGEHITSLTOM . '';
    }
    if ($orderby == 'hits DESC') {
        $orderbyTrans = '' . _WS_PAGEHITSMTOL . '';
    }
    if ($orderby == 'title ASC') {
        $orderbyTrans = '' . _WS_TITLEATOZ . '';
    }
    if ($orderby == 'title DESC') {
        $orderbyTrans = '' . _WS_TITLEZTOA . '';
    }
    if ($orderby == 'date ASC') {
        $orderbyTrans = '' . _WS_DATEOLD . '';
    }
    if ($orderby == 'date DESC') {
        $orderbyTrans = '' . _WS_DATENEW . '';
    }
    if ($orderby == 'rating ASC') {
        $orderbyTrans = '' . _WS_RATINGLTOH . '';
    }
    if ($orderby == 'rating DESC') {
        $orderbyTrans = '' . _WS_RATINGHTOL . '';
    }
    if ($orderby == 'votes ASC') {
        $orderbyTrans = '' . _WS_VOTESLTOM . '';
    }
    if ($orderby == 'votes DESC') {
        $orderbyTrans = '' . _WS_VOTESMTOL . '';
    }
    if ($orderby == 'views ASC') {
        $orderbyTrans = '' . _WS_VIEWSLTOM . '';
    }
    if ($orderby == 'views DESC') {
        $orderbyTrans = '' . _WS_VIEWSMTOL . '';
    }
    if ($orderby == 'lid ASC') {
        $orderbyTrans = '' . _WS_LIDLTOH . '';
    }
    if ($orderby == 'lid DESC') {
        $orderbyTrans = '' . _WS_LIDHTOL . '';
    }
    if ($orderby == 'cid ASC') {
        $orderbyTrans = '' . _WS_LIDLTOH . '';
    }
    ...
    if ($orderby == 'pid ASC') {
        $orderbyTrans = '' . _WS_PARENTLTOH . '';
    }
    if ($orderby == 'pid DESC') {
        $orderbyTrans = '' . _WS_PARENTHTOL . '';
    }
    if ($orderby == 'cattitle ASC') {
        $orderbyTrans = '' . _WS_CATTITLEATOZ . '';
    }
    if ($orderby == 'cattitle DESC') {
        $orderbyTrans = '' . _WS_CATTITLEZTOA . '';
    }
...
function player1Exist()
{
    ...
    if ($playerid == 0) {
        ...
        $eh = new ErrorHandler;
        $xoopsDB->queryF('INSERT INTO '
                         . $xoopsDB->prefix('webshow_player')
                         . " VALUES ($playerid, $pid, '$playertitle', $styleoption, '$bgcolor', '$backcolor', '$frontcolor', '$lightcolor', $width, $height, $displaywidth, $displayheight, $showdigits, $showfsbutton, $scroll, $largecontrol);")
        or $eh->show('0013');
    }
...
function getPlayerVardefault()
{
    ...
    $playervars    = array(
        ...
        'showfsbutton'  => $showfsbutton,
        'scroll'        => $scroll,
        'largecontrol'  => $largecontrol,
        'searchbar'     => $searchbar,
...
function getPlayerVar($playerid)
{
    ...
    $result =
        $xoopsDB->queryF('select playerid, pid, playertitle, styleoption, bgcolor, backcolor, frontcolor, lightcolor, width, height, displaywidth, displayheight, showdigits, showfsbutton, scroll, largecontrol, searchbar, searchlink from '
                         . $xoopsDB->prefix('webshow_player')
                         . " where playerid=$playerid");
    list($playerid, $pid, $playertitle, $styleoption, $bgcolor, $backcolor, $frontcolor, $lightcolor, $width, $height, $displaywidth, $displayheight, $showdigits, $showfsbutton, $scroll,
        $largecontrol, $searchbar, $searchlink) = $xoopsDB->fetchRow($result);
    if (!$playerid) {
        // Player doesn't exist so get default player 1
        $result2 =
            $xoopsDB->queryF('select pid, playertitle, styleoption, bgcolor, backcolor, frontcolor, lightcolor, width, height, displaywidth, displayheight, showdigits, showfsbutton, scroll, largecontrol, searchbar, searchlink from '
                             . $xoopsDB->prefix('webshow_player')
                             . ' where playerid=1') or $eh->show('0013');
        list($pid, $playertitle, $styleoption, $bgcolor, $backcolor, $frontcolor, $lightcolor, $width, $height, $displaywidth, $displayheight, $showdigits, $showfsbutton, $scroll, $largecontrol,
            $searchbar, $searchlink) = $xoopsDB->fetchRow($result2);
    ...
    $playervars = array(
        'playerid'      => $playerid,
        'pid'           => $pid,
        'playertitle'   => $myts->htmlSpecialChars($playertitle),
        'styleoption'   => $styleoption,
        'bgcolor'       => $bgcolor,
        'backcolor'     => $backcolor,
        'frontcolor'    => $frontcolor,
...
function getFVdefault()
{
    ...
    $flashvars  = array(
        ...
        'audio'      => $myts->htmlSpecialChars($audio)
    );
...
function getFV($lid, $flashvar)
{
    ...
    if ($lid != '') {
        if ($flashvar) {
            ...
            //** Query db for the entry FLASH VARIABLES
            $result =
                $xoopsDB->queryF('select lid, start, shuffle, replay, link, linktarget, showicons, stretch, showeq, rotatetime, shownav, transition, thumbslist, captions, enablejs, playerlogo, audio from '
                                 . $xoopsDB->prefix('webshow_flashvar')
                                 . " where lid=$lid") or $eh->show('0013');
            list($lid, $start, $shuffle, $replay, $link, $linktarget, $showicons, $stretch, $showeq, $rotatetime, $shownav, $transition, $thumbslist, $captions, $enablejs, $playerlogo, $audio) =
...
function wsadminTable($lid)
{
   ...
   <tr class='head' colspan='4'><td>" . _WSA_STATUS . '</td><td>' . _WSA_ID . '</td><td>' . _WSA_MEDIATITLE . '</td><td>' . _WSA_STATUSREPORT . '</td></tr>';
      ...
      <td class = 'even'><a href=\""
                           ...
                           . '/modules/'
                           . $xoopsModule->getVar('dirname')
                           . "/singlelink.php?lid=$lid\" target=\"_self\" title=\""
                           . _WS_ADMIN
                           . "\">"
                           . $title
                           . "</a></td>
      <td class = 'odd'><a href=\""
        ...
        while (list($lid, $title) = $xoopsDB->fetchRow($modresult)) {
            ...
            $title        = $myts->htmlSpecialChars($title);
            $admintable .= "<tr colspan='4'>
      <td class = 'even'><a href=\"" . XOOPS_URL . '/modules/' . $xoopsModule->getVar('dirname') . '/' . $statuslink . "\"><img src=\"" . XOOPS_URL . '/modules/' . $xoopsModule->getVar('dirname') . "/assets/assets/imagesonline.gif\" /></a></td>
      <td class = 'odd'>" . $lid . "</td>
      <td class = 'even'>
