...
document.getElementById("movie'
           . $lid
           . '").innerHTML = "EMBED TEST Movie Inc";
else
//document.getElementById("movie'
           . $lid
           . '").innerHTML = "JS Movie Test";
//var s'
           . $lid
           . ' = new SWFObject("'
           . XOOPS_URL
           ...
           . 's'
           . $lid
           . '.addVariable("autostart","true");s'
           . $lid
           . '.addVariable("file",mediafile);s'
           . $lid
           . '.addVariable("id","'
           . $lid
           . '");s'
           ...
           . $lid
           . '");
    var s1 = new SWFObject("http://localhost/testsite23/modules/webshow/mediaplayer.swf","play'
           . $lid
           . '","320","320","8");
    s1.addParam("allowfullscreen","true");
    s1.addParam("allowscriptaccess","always");
    ...
    s1.addVariable("enablejs","true");
    s1.addVariable("javascriptid","play'
           . $lid
           . '");
    s1.addVariable("width","320");
    s1.addVariable("height","320");
