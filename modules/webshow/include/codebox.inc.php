        ...
        if ($listtype == 'single') {
            ...
            if ($wfdwnok) {
                ...
                $downbutton = "<a href=\"#\" title=\""
                              ...
                              . "/assets/images/download.gif\" border=\"0\" alt=\""
                              . _WS_DOWNLOAD
                              . ' '
                              . $ltitle
                              . "\" /></a>";
            } else {
                $downlink   = "<a href=\"#\" title=\""
                              . _WS_DOWNLOAD
                              . ' '
                              . $ltitle
                              . "\" onclick= \"location='"
...
if (in_array('site', $showinfo) & in_array('site', $entryinfo)) {
    ...
    if ($url != '') {
        ...
        $sitebutton = '<a href="'
                      ...
                      . '/modules/'
                      . $xoopsModule->getVar('dirname')
                      . '/assets/images/link.gif" style="padding: 0 1px;" alt="'
                      . _VISITWEBSITE
                      . '" /></a>';
...
if ($listtype == 'feed' || $listtype == 'dir') {
    $feedbutton = '<a href="'
                  ...
                  . '/modules/'
                  . $xoopsModule->getVar('dirname')
                  . '/assets/imageswebfeed.gif" style="padding: 0 1px;" alt="'
                  . $ltitle
                  . '&nbsp;'
                  . _WS_WEBFEED
                  . '" /></a>';
...
if ($listtype != 'embed') {
    ...
    if (in_array('emb', $codebox)) {
        ...
        $embed    = "<object codebase=\"http://fpdownload.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=8,0,0,0\" width=\""
                    . $width
                    . "\" height=\""
                    . $height
                    ...
                    . '/'
                    . $flashplayer
                    . "\" name=\"movie\" /><param value=\"false\" name=\"menu\" /><param value=\"low\" name=\"quality\" /><param value=\"config="
                    . XOOPS_URL
                    . '/modules/'
                    . $xoopsModule->getVar('dirname')
                    . '/config.php?lid='
        ...
        $embedbox = '<div class="wscodeformrow">'
                    . _WS_EMBED
                    . '&nbsp;<input name="wsembedlink" type="text" value="'
                    . $embed
                    . '" size ="40" onclick="javascript:document.wscodeform.wsembedlink.focus();document.wscodeform.wsembedlink.select();" readonly="readonly" /></div>';
    }
    ...
    if (in_array('embjs', $codebox)) {
        ...
        $embedjsbox = '<div class="wscodeformrow">'
                      . _WS_EMBEDLINKJS
                      . '&nbsp;<input name="wsembedlinkjs" type="text" value="'
                      . $embedjs
                      . '" size ="40" onclick="javascript:document.wscodeform.wsembedlinkjs.focus();document.wscodeform.wsembedlinkjs.select();" readonly="readonly" /></div>';
    }
}
...
if (in_array('perma', $codebox)) {
    ...
    $permalinkbox = '<div class="wscodeformrow"><a href="'
                    . XOOPS_URL
                    . '/modules/'
                    . $xoopsModule->getVar('dirname')
                    . '/singlelink.php?lid='
                    ...
                    . '">'
                    . _WS_PERMALINK
                    . '</a>&nbsp;<input name="wspermalink" type="text" value="'
                    . $permalink
                    . '" size ="40" onclick="javascript:document.wscodeform.wspermalink.focus();document.wscodeform.wspermalink.select();" readonly="readonly" /></div>';
}
