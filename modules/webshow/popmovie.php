...
//** Get Playlist data
$result = $xoopsDB->query('select cid, title, srctype, listtype, listurl, listcache, cachetime, entryinfo, logourl, player, entryperm from '
...
if ($listtype == 'embed') {
    $mplayjs = '';
    include __DIR__ . '/plugin/' . $srctype . '.php';
...
echo "<div class=\"itemHead\" style=\"float: left; width: "
     . $width
     . "px; margin: 5px 5px 0px 0px;\">
         <div class=\"itemTitle\" style=\"float: left; width: "
     . $width
     . "px; text-align: center; font-size: 90%;\"><a href=\""
     . XOOPS_URL
     . '/modules/'
     . $xoopsModule->getVar('dirname')
     . '/singlelink.php?lid='
     ...
     . "</a></div>
          ...
          <div class=\"itemBody\" style=\"width: "
     . $width
