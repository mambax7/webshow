...
define('_WSA_WEBSHOW_DISCLAIMER',
       "<b>Disclaimer: </b>By installing and using the WebShow module you agree that you will not use it to display, distribute or syndicate a third party's copyright protected media without the owner's permission.  The WebShow software is not to be used to display or syndicate illegal or copyright protected media.");
define('_WSA_WEBSHOW_DSC',
       '<b>Introduction: </b>This module plays Flash media files (swf, flv, jpg, png, gif, mp3) enclosed in an atom, xspf or rss web feed.  It will filter a media directory by file type to automatically generate and save an xspf playlist.  Plays single media files from a url.  Custom player appearance and behavior.');
...
define('_WSA_SUBMITTEXT',
       'Submit links that point to your Flash media (flv, swf, mp3, jpg, gif, png) files, streams, podcast feeds or shared embed sites.  We do not accept media uploads at the moment.');
define('_WSA_SUBMIT_TOS',
       "Review and abide by our Terms of Service. Do not contribute other's copyrighted materials without permission from the owner. Your User name and IP will be attached to this submission.");
define('_WSA_SUBMIT_FEED', 'Enter the link to a playlist feed in RSS, ATOM or XSPF xml file format.');
define('_WSA_SUBMIT_SINGLE',
       'Enter an URL pointing to a video (.flv), audio (.mp3) or a image (jpg, gif, png) file.  We do not accept uploads.  Upload to a media storage site and publish the link here.');
...
define('_WSA_STRETCHDSC',
       'False = Scale proportionally to fit the display.<br>Fit = Scale disproportionally to exactly fit the display.<br>True = Scale proportionally to fill the display.<br>None = Original size.<br>');
