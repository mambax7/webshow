...
// The name of this module
//define('_MI_WEBSHOW_NAME',"XXXXX Module Name");
define('_MI_WEBSHOW_DIRNAME', basename(dirname(dirname(__DIR__))));

define('_MI_WEBSHOW_HELP_OVERVIEW', 'Overview');
define('_MI_WEBSHOW_HELP1', 'XXXXX');
define('_MI_WEBSHOW_HELP2', 'XXXXX');
define('_MI_WEBSHOW_HELP3', 'XXXXX');
define('_MI_WEBSHOW_HELP4', 'XXXXX');
define('_MI_WEBSHOW_HELP5', 'XXXXX');
define('_MI_WEBSHOW_HELP6', 'XXXXX');
