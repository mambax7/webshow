...
//  ------------------------------------------------------------------------ //
/////////////////////////////////////////////////////////////
// Title    : Frame Branding Hack for Xoops WebShow        //
// Author   : Freeop                                       //
...
$mail_body    =
    rawurlencode(sprintf(_WS_INTLINKFOUND, $xoopsConfig['sitename']) . ':  ' . XOOPS_URL . 'modules/' . $xoopsModule->getVar('dirname') . '/singlelink.php?lid=' . $lid . '&amp;cid=' . $cid);
?>
            ...
            <table class="bg3" width=95% cellspacing="2" cellpadding="3" border="0" style="border: #e0e0e0 1px solid;">
                ...
                <tr>
                    <td class='bg4' align="center">
                        <small>
                            <a target="main" href="ratelink.php?cid=<?php echo $cid; ?>&amp;lid=<?php echo $lid; ?>"><?php echo _WS_RATETHISSITE; ?></a> | <a target="main"
                                                                                                                                                              href="modlink.php?lid=<?php echo $lid; ?>"><?php echo _WS_MODIFY; ?></a>
                            | <a
                                target="main" href="brokenlink.php?lid=<?php echo $lid; ?>"><?php echo _WS_REPORTBROKEN; ?></a> | <a target='_top'
                                                                                                                                     href='mailto:?subject=<?php echo $mail_subject; ?>&body=<?php echo $mail_body; ?>'><?php echo _WS_TELLAFRIEND; ?></a>
