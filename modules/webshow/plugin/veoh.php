...
// Original: <embed src="http://www.veoh.com/videodetails2.swf?permalinkId=v1688234qJjc3gNG&id=anonymous&player=videodetailsembedded&videoAutoPlay=0" allowFullScreen="true" width="540" height="438" bgcolor="#000000" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer"></embed><b><a href="http://www.veoh.com/">Online Videos by Veoh.com</a>
$movie = '<embed src="http://www.veoh.com/videodetails2.swf?permalinkId='
         . $listurl
         . '&id=anonymous&amp;player=videodetailsembeddedamp;videoAutoPlay=0" allowFullScreen="true" width="'
         . $width
         . '" height="'
         . $height
         . '" bgcolor="#000000" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer"></embed>';
