...
$movie = '<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,0,0" width="'
         . $width
         . '" height="'
         . $height
         . '" id="playerEmbedCollections" align="middle"><param name="allowScriptAccess" value="always" /><param name="allowFullScreen" value="true" /><param name="wmode" value="transparent"><param name="movie" value="http://www.graspr.com/html/flashplayer/swf/playerEmbedCollections.swf?collectionID='
         . $listurl
         . '&pid=25553&gh=www&swid=20&lid=0" /><param name="quality" value="high" /><param name="bgcolor" value="#000000" /><embed src="http://www.graspr.com/html/flashplayer/swf/playerEmbedCollections.swf?collectionID='
         . $listurl
         . '&pid=25553&gh=www" quality="high" bgcolor="#000000" width="'
         . $width
         . '" height="'
         . $height
         . '" name="playerEmbedCollections" align="middle" allowScriptAccess="always" allowFullScreen="true" wmode="transparent" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" /></embed></object>';
