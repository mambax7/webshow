...
$embed_dsc =
    'Google Video displays video from multiple sources.  This embed link is for media hosted at video.google.com only. <br><strong>Enter the Docid from the url.</strong><br>Example: http://video.google.com/videoplay?docid=<span style="color: #FF0000;">3166797753930210643</span>.';
...
$movie = '<embed style="width:'
         . $width
         . 'px; height:'
         . $height
         . 'px;" id="VideoPlayback" type="application/x-shockwave-flash" src="http://video.google.com/googleplayer.swf?docId='
         . $listurl
         . '" flashvars=""> </embed>';
