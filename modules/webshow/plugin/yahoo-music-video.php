...
$movie = '<object width="'
         ...
         . '" height="'
         . $height
         . '" id="uvp_fop" allowFullScreen="true"><param name="movie" value="http://d.yimg.com/m/up/fop/embedflv/swf/fop.swf"/><param name="flashVars" value="id=v'
         . $listurl
         . '&amp;lang=us&amp;enableFullScreen=0&amp;shareEnable=1"/><param name="wmode" value="transparent"/><embed height="'
         . $height
         . '" width="'
         . $width
         . '" id="uvp_fop" allowFullScreen="true" src="http://d.yimg.com/m/up/fop/embedflv/swf/fop.swf" type="application/x-shockwave-flash" flashvars="id=v'
         . $listurl
         . '&amp;lang=us&amp;enableFullScreen=1&amp;shareEnable=1" /></object>';
