...
$movie = '<embed width="'
         ...
         . '" height="'
         . $height
         . '" src="http://www.spike.com/efp" quality="high" bgcolor="'
         . $backcolor
         . '" name="efp" align="middle" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" flashvars="flvbaseclip='
         . $listurl
