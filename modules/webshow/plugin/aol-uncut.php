...
$movie = '<object width="'
         ...
         . '" height="'
         . $height
         . '"><param name="wmode" value="opaque" /><param name="movie" value="http://uncutvideo.aol.com/v6.334/en-US/uc_videoplayer.swf" /><param name="FlashVars" value="aID='
         . $listurl
         . '&amp;site=http://uncutvideo.aol.com/"/><embed src="http://uncutvideo.aol.com/v6.334/en-US/uc_videoplayer.swf" wmode="opaque" FlashVars="aID=1'
         . $listurl
         . '&amp;site=http://uncutvideo.aol.com/" width="'
         . $width
         . '" height="'
         . $height
