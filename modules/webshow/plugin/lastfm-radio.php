...
$movie     =
    '<object type="application/x-shockwave-flash" data="http://cdn.last.fm/widgets/radio/26.swf" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,0,0" width="'
    . $width
    . '" height="'
    . $height
    . '" > <param name="movie" value="http://cdn.last.fm/widgets/radio/26.swf" /> <param name="flashvars" value="lfmMode=radio&amp;radioURL=globaltags%2F'
    . $lastfmtag
    . '&amp;title=Music+tagged+'
    . $lastfmtag
    . '+&amp;theme=blue&amp;lang=en&amp;widget_id=radio_d0f693faead02e5227e309077c6e4e64" /> <param name="bgcolor" value="'
    . $backcolor
    . '" /> <param name="quality" value="high" /> <param name="allowScriptAccess" value="always" /> <param name="allowNetworking" value="all" /> </object>';
