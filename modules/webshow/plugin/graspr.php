...
$movie = '<object width="'
         ...
         . '" height="'
         . $height
         . '"><param name="movie" value="http://www.graspr.com/html/flashplayer/swf/home_player.swf?dataID=http://www.graspr.com/html/flashplayer/data/data.php%3Fv='
         . $listurl
         . '&pid=25553&gh=www" /><param name="wmode" value="transparent" /><embed src="http://www.graspr.com/html/flashplayer/swf/home_player.swf?dataID=http://www.graspr.com/html/flashplayer/data/data.php%3Fv='
         . $listurl
         . '&pid=25553&gh=www" quality="high" bgcolor="#ffffff" width="'
         . $width
         . '" height="'
         . $height
         . '" name="myPlayer" swLiveConnect="true" align="left" allowFullScreen="true" allowScriptAccess="always" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer"></embed></object>';
