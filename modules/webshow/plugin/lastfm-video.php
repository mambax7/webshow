...
$movie = '<object width="'
         ...
         . '" height="'
         . $height
         . '" id="player" classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="http://fpdownload.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,0,0" align="middle"> <param name="movie" value="http://cdn.last.fm/videoplayer/33/VideoPlayer.swf" /> <param name="menu" value="false" /> <param name="quality" value="high" /> <param name="bgcolor" value="'
         . $backcolor
         . '" /> <param name="allowFullScreen" value="true" /> <param name="flashvars" value="embed=true&amp;uniqueName='
         . $listurl
         . '&amp;image=http://userserve-ak.last.fm/serve/image:320/'
         . $listurl
         . '.jpg&FSSupport=true" /> <embed src="http://cdn.last.fm/videoplayer/33/VideoPlayer.swf" menu="false" quality="high" bgcolor="'
         . $backcolor
         . '" width="'
         . $width
         . '" height="'
         . $height
         . '" name="player" align="middle" allowFullScreen="true" flashvars="embed=true&amp;uniqueName='
         . $listurl
         . '&amp;image=http://userserve-ak.last.fm/serve/image:320/'
         . $listurl
         . '.jpg&amp;FSSupport=true" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" /> </object>';
