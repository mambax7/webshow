...
$movie = '<object width="'
         ...
         . '" height="'
         . $height
         . '" classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="http://fpdownload.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,0,0" align="middle"> <param name="allowScriptAccess" value="always" /><param name="wmode" value="transparent" /> <param name="movie" value="http://widgets.jamendo.com/en/album/?album_id='
         . $listurl
         . '&amp;playertype=2008" /> <param name="quality" value="high" /> <param name="bgcolor" value="'
         . $backcolor
         . '" /> <embed src="http://widgets.jamendo.com/en/album/?album_id='
         . $listurl
         . '&amp;playertype=2008" base="http://widgets.jamendo.com/en/album/" quality="high" wmode="transparent" bgcolor="'
         . $backcolor
         . '" width="'
         . $width
         . '" height="'
         . $height
         . '" align="middle" allowScriptAccess="always" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer">&amp;nbsp;</embed>&amp;nbsp;</object>';
