<div style="float: left; width: 100%; margin: 0px; padding: 0px; text-align: left;">
    <{foreach item=link from=$block.links}>
        <{if $link.movie !=""}>
            <{$link.movie}>
        <{/if}>
        <div style="float: left; width: auto; margin: 0px; padding: 2px;">
            <h3 style="float: left; width: 98%; margin: 0px; padding: 2px 2px 0px 2px; font-size: 90%;">
                <{ if $link.title !=""}>
            ...
            <{/if}>
            <{if $link.stats == 1}>
                <div style="clear: left; margin: 0px; padding: 2px; font-size:80%;">
            ...
            <{/if}>
            <{ if $link.description !=""}>
            <div style="clear: left; margin: 0px; padding: 2px 3px 0px 3px; font-size: 90%;">
                <{$link.description}>
            </div>
            <{/if}>
        </div>
