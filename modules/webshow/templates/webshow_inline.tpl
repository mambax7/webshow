...
<{if $themefromplayer}>
    <style>
        .item {
            border: 1px solid <{$screen.backcolor}>;
            background-color: <{$screen.bgcolor}>;
        }

        .item a {
            color: <{$screen.frontcolor}>;
        }

        .item a:hover {
            color: <{$screen.lightcolor}>;
        }
        ...
        .itemBody {
            background-color: <{$screen.bgcolor}>;
            border: 0px;
            color: <{$screen.backcolor}>;
        }

        .itemText {
            color: <{$screen.backcolor}>;
            background-color: <{$screen.frontcolor}>;
        }
        ...
        function doWork(worklink, op) {
            ...
            if (httpObject != null) {
                ...
                if (op == 'ratestats')
                    ...
                    httpObject.onreadystatechange = setInfobox;
                    showstuff('boxswitch');
                }
                if (op == 'wsrate')
