...
$xoopsOption['template_main'] = 'webshow_index.tpl';
...
if (!$numrows) {
    ...
    $sql    =
        ...
        . " t where l.status>0 and cid >0 and l.lid=t.lid ORDER by $orderby";
            ...
            if (count(array_intersect($group, $ws_entryperm)) > 0) {
                ...
                if (in_array('pop', $showinfo) & in_array('pop', $entryinfo)) {
                    $popbutton = "<span onclick= \"window.open('popmovie.php?lid="
                                 ...
                                 . "','popmovie"
                                 . $lid
                                 . "','directories=no,toolbar=no,location=no,menubar=no');return false;\"><img src=\""
                                 . XOOPS_URL
                                 . '/modules/'
                                 . $xoopsModule->getVar('dirname')
